<?php 
  include'koneksi.php';
    ...
    $perintahSQL="SELECT * FROM PEMINJAMAN ORDER BY KODE_PINJAM ASC";
    ...
    //   $statement = "SELECT * FROM PEMINJAMAN
    //               WHERE 
    //             KODE_PINJAM LIKE '%$keyword%' OR 
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <input class="form-control form-control-dark w-100"type="text" placeholder="Search" aria-label="Search" name="keywords">
