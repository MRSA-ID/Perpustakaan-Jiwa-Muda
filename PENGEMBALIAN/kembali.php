<?php 
  include'koneksi.php';
    ...
    $perintahSQL="SELECT * FROM PENGEMBALIAN ORDER BY KODE_KEMBALI ASC";
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <h1 class="h2">Data Yang Telah Mengembalikan buku</h1>
            ...
            <tr class="align-middle">
              ...
              <td>
                <div class="btn-group me-2 " id="action" >
                  <a class="btn btn-outline-success btn-sm" readonly  role="button">Dikembalikan</a>
                </div>
              </td>
            </tr>
          </tbody>
