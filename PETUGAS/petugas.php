<?php 
		include'koneksi.php';
		$perintahSQL="SELECT * FROM PETUGAS ORDER BY ID_PETUGAS ASC";
            ...
            <tr class="align-middle">
              ...
              <td>
                <div class="btn-group me-2 " id="action" >
                  <a class="btn btn-outline-success btn-sm" href="edit.php?id=<?= $data['ID_PETUGAS']; ?>" role="button">Edit</a>
                  <a class="btn btn-outline-danger btn-sm" href="hapus.php?id=<?= $data['ID_PETUGAS'];?>" role="button">Hapus</a>
                </div>
              </td>
            </tr>
          </tbody>
