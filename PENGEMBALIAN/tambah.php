			...
			<div class="col-md-8 col-lg-10">
				<form action="proses-tambah.php" method="post" class="needs-validation">
						...
						<div class="col-sm-12">
							...
							<input type="text" class="form-control" id="kmbl" name="kmbl" placeholder="Tanggal Pengembalian " required>
						</div>
						<div class="col-sm-12">
							<label for="kodePinjam" class="form-label">Kode Peminjaman</label>
							<input type="text" class="form-control" id="kodePinjam" name="kodePinjam" placeholder="Kode Peminjaman" required>
						</div>
						<div class="col-sm-12">
							<label for="denda" class="form-label">Denda </label>
							<input type="text" class="form-control" id="denda" name="denda" placeholder="Masukkan Denda " required>
						</div>
						<div class="col-sm-12">
