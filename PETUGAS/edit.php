<?php 
	...
	$statement="SELECT * FROM PETUGAS WHERE ID_PETUGAS = $id";
	...
	<main>
		...
		<div class="row g-3">
			<div class="col-md-8 col-lg-10">
				<form action="proses-edit.php?id=<?= $data['ID_PETUGAS'];?>" method="post" class="needs-validation">
						...
						<div class="col-sm-12">
							...
							<input type="text" class="form-control" id="jbtn" name="jbtn" required value="<?= $data['JABATAN'];?>">
						</div>
						<div class="col-sm-12">
							<label for="telp" class="form-label">No.telephone</label>
							<input type="text" class="form-control" id="telp" name="telp" required value="<?= $data['NO_TELP'];?>">
						</div>
						<div class="col-sm-12">
