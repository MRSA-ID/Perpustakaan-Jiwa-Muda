<?php 
  include'koneksi.php';
    ...
    $perintahSQL="SELECT * FROM ANGGOTA ORDER BY ID_ANGGOTA ASC";
            ...
            <tr class="align-middle">
              ...
              <td>
                <div class="btn-group me-2 " id="action" >
                  <a class="btn btn-outline-success btn-sm" href="edit.php?id=<?= $data['ID_ANGGOTA']; ?>" role="button">Edit</a>
                  <a class="btn btn-outline-danger btn-sm" href="hapus.php?id=<?= $data['ID_ANGGOTA'];?>" role="button">Hapus</a>
                </div>
              </td>
            </tr>
          </tbody>
