<?php 
		include'koneksi.php';
		$perintahSQL="SELECT * FROM RAK ORDER BY KODE_RAK ASC";
            ...
            <tr class="align-middle">
              ...
              <td>
                <div class="btn-group " id="action" >
                  <a class="btn btn-outline-success btn-sm" href="edit.php?id=<?= $data['KODE_RAK']; ?>" role="button">Edit</a>
                  <a class="btn btn-outline-danger btn-sm" href="hapus.php?id=<?= $data['KODE_RAK'];?>" role="button">Hapus</a>
                </div>
              </td>
            </tr>
          </tbody>
